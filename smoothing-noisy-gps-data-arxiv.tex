...
\author{Jeffrey J. Early, Northwest Research Associates, USA \\ Adam M. Sykulski, Lancaster University, UK}
\maketitle
\thispagestyle{empty}
...
\centering
\begin{tabular}{r r p{1.15cm} | p{1cm}p{1cm}p{1cm}p{1cm}} stride & $n_\textrm{eff}$ & optimal mse & reduced dof & blind initial & expected mse \\ \hline \hline 
$\omega^{-2}$ &&&&&  \\ \hline 
...
%%%%%%%%%%%%%%%%%%%%%%
%
\section*{Appendix A: Numerical implementation}
...
%%%%%%%%%%%%%%%%%%%%%%
\section*{B: Iteratively reweighted least squares}
\label{sec:irls}
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%
\section*{C: Estimating the variance of the signal}
%%%%%%%%%%%%%%%%%%%%%%
...
\bibitem[{Bracco et~al.(2000)Bracco, LaCasce,, and Pasquero}]{bracco2000-pf}
Bracco, A., J.~H. LaCasce, and C.~Pasquero, 2000: {The velocity distribution of
  barotropic turbulence}. \textit{Phys. Fluids}, \textbf{12~(10)}, 2478.

\bibitem[{Cantoni and Hastie(2002)Cantoni, and Hastie}]{cantoni2002-biom}
Cantoni, E., and T.~Hastie, 2002: {Degrees-of-freedom tests for smoothing
  splines}. \textit{Biometrika}, \textbf{89~(2)}, 251--263.

\bibitem[{Craven and Wahba(1979)Craven, and Wahba}]{craven1979-nm}
Craven, P., and G.~Wahba, 1979: {Smoothing noisy data with spline functions}.
  \textit{Numer. Math.}, \textbf{31~(4)}, 377--403.

\bibitem[{De~Boor(1978)}]{deboor1978-book}
De~Boor, C., 1978: \textit{{A practical guide to splines}}, Vol.~27.
  Springer-Verlag New York.

\bibitem[{Elipot et~al.(2016)Elipot, Lumpkin, Perez, Early,, and
  Sykulski}]{elipot2016-jgr}
Elipot, S., R.~Lumpkin, R.~Perez, J.~J. Early, and A.~M. Sykulski, 2016: {A
  global surface drifter dataset at hourly resolution}. \textit{J. Geophys.
  Res. Oceans}.

\bibitem[{Green and Silverman(1994)Green, and Silverman}]{green1994-book}
Green, P.~J., and B.~W. Silverman, 1994: \textit{{Nonparametric Regression and
  Generalized Linear Models: A Roughness Penalty Approach}}. Chapman {\&} Hall,
  London.

\bibitem[{Lee(2003)}]{lee2003-csda}
Lee, T. C.~M., 2003: {Smoothing parameter selection for smoothing splines: a
  simulation study}. \textit{Comput. Stat. Data Anal.}, \textbf{42~(1-2)},
  139--148.

\bibitem[{Lilly et~al.(2017)Lilly, Sykulski, Early,, and
  Olhede}]{lilly2017-npg}
Lilly, J.~M., A.~M. Sykulski, J.~J. Early, and S.~C. Olhede, 2017: {Fractional
  Brownian motion, the Mat{\'e}rn process, and stochastic modeling of turbulent
  dispersion}. \textit{Nonlin. Processes Geophys.}, \textbf{24~(3)}, 481--514.

\bibitem[{Press et~al.(1992)Press, Teukolsky, Vetterling,, and
  Flannery}]{press1992-book}
Press, W.~H., S.~A. Teukolsky, W.~T. Vetterling, and B.~P. Flannery, 1992:
  \textit{{Numerical Recipes in C}}. 2nd ed., The Art of Scientific Computing,
  Cambridge University Press.

\bibitem[{Reinsch(1967)}]{reinsch1967-nm}
Reinsch, C.~H., 1967: {Smoothing by spline functions}. \textit{Numer. Math.},
  \textbf{10~(3)}, 177--183.

\bibitem[{Shcherbina et~al.(2015)}]{shcherbina2015-bams}
Shcherbina, A.~Y., and Coauthors, 2015: {The LatMix Summer Campaign:
  Submesoscale Stirring in the Upper Ocean}. \textit{Bull. Amer. Meteor. Soc.},
  \textbf{96~(8)}, 1257--1279.

\bibitem[{Sykulski et~al.(2016)Sykulski, Olhede, Lilly,, and
  Danioux}]{sykulski2016-jrssc}
Sykulski, A.~M., S.~C. Olhede, J.~M. Lilly, and E.~Danioux, 2016: {Lagrangian
  time series models for ocean surface drifter trajectories}. \textit{J. R.
  Statist. Soc. C}, \textbf{65~(1)}, 29--50.

\bibitem[{Teanby(2007)}]{teanby2007-mg}
Teanby, N.~A., 2007: {Constrained Smoothing of Noisy Data Using Splines
  in~Tension}. \textit{Math Geol}, \textbf{39~(4)}, 419--434.

\bibitem[{{WAAS T{\&}E Team}(2016)}]{faa2016-report}
{WAAS T{\&}E Team}, 2016: {Global Positioning System (GPS) Standard Positioning
  Service (SPS) Performance Analysis Report}. Tech. Rep.~92, William J. Hughes
  Technical Center.

\bibitem[{Wahba(1978)}]{wahba1978-jrss-b}
Wahba, G., 1978: {Improper priors, spline smoothing and the problem of guarding
  against model errors in regression}. \textit{J. R. Statist. Soc. B}.

\bibitem[{Whittaker(1923)}]{whittaker1923-pems}
Whittaker, E.~T., 1923: {On a New Method of Graduation}. \textit{Proceedings of
  the Edinburgh Mathematical Society}, \textbf{41~(01)}, 63--75.
